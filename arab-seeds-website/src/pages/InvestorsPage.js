  ...
  <div className="space-y-12 pb-20 pt-10 bg-gradient-to-b from-amber-50 to-white dark:from-[#1c1813] dark:to-[#1c1813]">
    <section className="max-w-6xl mx-auto px-4">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-10 border-b border-gray-200 dark:border-[#332e27] pb-6 gap-4">
        <div>
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">علاقات المستثمرين</h1>
          <p className="text-gray-600 dark:text-gray-400">البيانات المالية وتقارير الحوكمة والشفافية</p>
        </div>
        <div className="flex gap-4">
          <button className="text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm flex items-center gap-2">
            <Briefcase className="w-4 h-4"/> تقارير مالية
          </button>
          <button className="text-yellow-600 dark:text-yellow-500 text-sm flex items-center gap-2 font-medium border-b border-yellow-600 dark:border-yellow-500 pb-1">
            <Calendar className="w-4 h-4"/> مفكرة المستثمرين
          </button>
        </div>
      </div>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            ...
            <Button variant="outline" className="text-xs py-1.5">
              <Download className="w-4 h-4" /> حمل PDF
            </Button>
          </div>
          <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-[#332e27] shadow-sm">
            <table className="w-full text-sm text-right">
              <thead className="bg-amber-100 dark:bg-[#2a2520] text-gray-700 dark:text-gray-300">
                <tr>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27] w-1/2">البيان (القيم بالجنيه المصري)</th>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27]">30 يونيو 2025</th>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27]">30 سبتمبر 2025</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-[#1c1813] divide-y divide-gray-200 dark:divide-[#332e27]">
                <tr><td colSpan="3" className="p-4 text-yellow-600 dark:text-yellow-500 font-bold bg-amber-50 dark:bg-[#221e1a]">الأصول غير المتداولة</td></tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">صافي الأصول الثابتة</td>
                ...
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">مشروعات تحت التنفيذ</td>
                ...
                <tr className="font-bold bg-amber-50 dark:bg-[#221e1a]">
                  <td className="p-4 text-yellow-600 dark:text-yellow-500">إجمالي الأصول غير المتداولة</td>
                ...
                <tr><td colSpan="3" className="p-4 text-yellow-600 dark:text-yellow-500 font-bold bg-amber-50 dark:bg-[#221e1a]">الأصول المتداولة</td></tr>
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">المخزون</td>
                ...
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">حسابات مدينة</td>
                ...
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">النقدية وما في حكمها</td>
                ...
                <tr className="font-bold bg-amber-50 dark:bg-[#221e1a]">
                  <td className="p-4 text-yellow-600 dark:text-yellow-500">إجمالي الأصول المتداولة</td>
                ...
                <tr className="font-bold bg-yellow-100 dark:bg-yellow-500/10">
                  <td className="p-4 text-gray-900 dark:text-white text-lg">إجمالي الأصول</td>
        ...
        <div>
          ...
          <div className="overflow-x-auto rounded-lg border border-gray-200 dark:border-[#332e27] shadow-sm">
            <table className="w-full text-sm text-right">
              <thead className="bg-amber-100 dark:bg-[#2a2520] text-gray-700 dark:text-gray-300">
                <tr>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27] w-1/2">البيان</th>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27]">30 يونيو 2025</th>
                  <th className="p-4 border-b border-gray-200 dark:border-[#332e27]">30 سبتمبر 2025</th>
                </tr>
              </thead>
              <tbody className="bg-white dark:bg-[#1c1813] divide-y divide-gray-200 dark:divide-[#332e27]">
                <tr className="hover:bg-gray-50 dark:hover:bg-[#221e1a]">
                  <td className="p-4 text-gray-700 dark:text-gray-300">المصروفات الإدارية والعمومية</td>
                  <td className="p-4 text-red-600 dark:text-red-400">(1,500,000)</td>
                  <td className="p-4 text-red-600 dark:text-red-400">(2,050,000)</td>
                </tr>
                <tr className="font-bold bg-yellow-100 dark:bg-yellow-500/10">
                  <td className="p-4 text-gray-900 dark:text-white text-lg">صافي ربح الفترة</td>
