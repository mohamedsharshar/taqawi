...
const ShareholdersPage = () => {
  ...
  <div className="space-y-16 pb-20 pt-10 bg-gradient-to-b from-amber-50 to-white dark:from-[#1c1813] dark:to-[#1c1813]">
    <section className="max-w-6xl mx-auto px-4">
      <div className="h-64 bg-cover bg-center bg-no-repeat rounded-xl flex items-center justify-center relative overflow-hidden mb-12 shadow-lg" style={{ backgroundImage: 'url(https://images.pexels.com/photos/3184292/pexels-photo-3184292.jpeg?auto=compress&cs=tinysrgb&w=1200)' }}>
        ...
        <div className="z-20 text-center px-4">
          <h1 className="text-4xl font-bold text-white mb-4">{t('shareholders.hero.title')}</h1>
          <p className="text-gray-100 max-w-2xl mx-auto">
            {t('shareholders.hero.description')}
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="max-w-6xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-3 gap-8">
      <div className="lg:col-span-2">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{t('shareholders.table.title')}</h2>
        ...
        <div className="bg-white dark:bg-[#221e1a] rounded-xl border border-gray-200 dark:border-[#332e27] overflow-hidden shadow-lg">
          <table className="w-full text-sm text-right">
            <thead className="bg-amber-100 dark:bg-[#2a2520]">
              <tr>
                <th className="p-4 text-gray-700 dark:text-gray-300 font-medium">{t('shareholders.table.shareholder')}</th>
                <th className="p-4 text-gray-700 dark:text-gray-300 font-medium text-center">{t('shareholders.table.shares')}</th>
                <th className="p-4 text-gray-700 dark:text-gray-300 font-medium text-center">{t('shareholders.table.percentage')}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gray-200 dark:divide-[#332e27]">
              <tr className="hover:bg-gray-50 dark:hover:bg-[#2a2520]/50">
                <td className="p-4 text-gray-900 dark:text-white">{t('shareholders.companies.international')}</td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-[#2a2520]/50">
                <td className="p-4 text-gray-900 dark:text-white">{t('shareholders.companies.safa')}</td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-[#2a2520]/50">
                <td className="p-4 text-gray-900 dark:text-white">{t('shareholders.companies.egyptian')}</td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-[#2a2520]/50">
                <td className="p-4 text-gray-900 dark:text-white">{t('shareholders.companies.bank')}</td>
              ...
              <tr className="hover:bg-gray-50 dark:hover:bg-[#2a2520]/50">
                <td className="p-4 text-gray-900 dark:text-white">{t('shareholders.companies.taiba')}</td>
      ...
      <div className="lg:col-span-1">
        <Card className="h-full flex flex-col items-center justify-center text-center">
          <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-8">{t('shareholders.distribution.title')}</h3>
          <div className="relative w-48 h-48 rounded-full border-[16px] border-gray-200 dark:border-[#332e27] flex items-center justify-center mb-8 shadow-inner">
            <div className="text-center z-10">
              ...
              <span className="text-xs text-gray-500">{t('shareholders.distribution.totalShares')}</span>
            </div>
          </div>
          <ul className="text-sm space-y-2 text-right w-full text-gray-700 dark:text-gray-300">
            <li className="flex items-center gap-2">
              ...
              {t('shareholders.distribution.legend1')}
            </li>
            <li className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-gray-400"></span>
              {t('shareholders.distribution.legend2')}
            </li>
            <li className="flex items-center gap-2">
              <span className="w-3 h-3 rounded-full bg-gray-300 dark:bg-[#332e27]"></span>
              {t('shareholders.distribution.legend3')}
            </li>
          </ul>
        </Card>
      </div>
    ...
    <section className="max-w-6xl mx-auto px-4">
      <SectionTitle 
        title={t('shareholders.board.title')} 
        subtitle={t('shareholders.board.subtitle')} 
        className="mb-10" 
      />
      ...
      <div className="mt-8 bg-yellow-50 dark:bg-yellow-500/10 border border-yellow-200 dark:border-yellow-500/30 rounded-lg p-6 flex items-start gap-4 shadow-sm">
        ...
        <div>
          <h4 className="text-yellow-600 dark:text-yellow-500 font-bold mb-1">{t('shareholders.board.governance.title')}</h4>
          <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">
            {t('shareholders.board.governance.description')}
          </p>
        </div>
      </div>
    </section>
